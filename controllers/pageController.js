...
// GET /page
exports.getPage = async (req, res, pageName, pageTitle) => {
...
exports.checkAnswer = async (req, res, pageName, pageTitle) => {
    ...
    console.log(`/${pageName}?num1=${num1}&num2=${num2}&answer=${userAnswer}&product=${calculatedAnswer}&message=${encodeURIComponent(message)}&correctAnswer=${isAnswerCorrect}`);
    res.redirect(`/${pageName}?num1=${num1}&num2=${num2}&answer=${userAnswer}&product=${calculatedAnswer}&message=${encodeURIComponent(message)}&correctAnswer=${isAnswerCorrect}`);
};
